...
if(isset($_POST['updateProduct'])){
    ...
    if($_FILES['image']['name']){
        ...
        if(in_array(strtolower($ext), ['jpg','jpeg','png','gif'])){
            ...
            if($old['image'] != 'default.png' && file_exists("uploads/".$old['image'])){
...
if(isset($_POST['deleteProduct'])){
    ...
    if($row && $row['image'] != 'default.png' && file_exists("uploads/".$row['image'])){
...
<td>
<img src="uploads/<?= htmlspecialchars($row['image']) ?>" width="60" onerror="this.src='uploads/default.png'">
</td>
<td>
